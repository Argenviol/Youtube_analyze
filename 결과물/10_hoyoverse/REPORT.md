...
- 수집 2026-09-05 · 캐릭터 205명(가챠 대상 205명,
...
- **공식 푸시 1위**(5성·최신 출시): 어벤츄린•웨이브(붕괴:스타레일, 2026-09-12 출시)
- **유저 반응 1위**(리뷰 언급량): 반디(붕괴:스타레일, 70건 언급)
- 매칭 가능한 캐릭터(이름 2글자 이상) 203명 중 **81명은 수집된 리뷰
