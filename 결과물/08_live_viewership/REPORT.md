...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-12T14:38 (UTC), 약 8.7시간 / 스냅샷 42시점 · 461건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +132명 (일 환산 +363명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 11건 (기준 5건), 실관측 7.0시간 (기준 24시간) — 달력 구간은 8.7시간이지만 커버리지 80%, 최대 단절 3.1시간
