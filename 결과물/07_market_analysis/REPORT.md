...
- 프로젝트6 자체 데이터 기준(데뷔 시기를 맞춘 코호트 비교): **2023 데뷔** 코호트에서 구독자 중앙값은 320,000 대 995,000, 도달 효율은 65% 대 25%; **2024 데뷔** 코호트에서 구독자 중앙값은 226,000 대 652,000, 도달 효율은 87% 대 24% — 규모가 아니라 구독자 대비 실제 시청 비율에서 위치를 잡는 구조입니다.
