...
- 데이터 소스: YouTube Data API v3 (멤버명+키리누키/클립/切り抜き 검색), 수집 2026-08-22
- 공식 채널 제외 후 팬 제작 클립만 집계: 클립 306개 · 팬채널 69개
- 필터: 제목/채널명 키리누키·클립 토큰

## 한눈에

- **팬 클립 총 조회수 1위**: 텐코 시부키 — 5.3M (25개 클립)
- **가장 많은 팬채널이 다루는 멤버**: 하나코 나나 — 18개 채널
- **최대 키리누키 채널**: 서트 클립 Surt Clip — 총 2.7M (4개)
- 생태계 표본 합계 조회수: 20.7M

## 근거 자료

### 차트 6종 (최신 실행 2026-08-22 기준)
