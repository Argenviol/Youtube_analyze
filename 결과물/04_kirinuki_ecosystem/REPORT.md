...
- 데이터 소스: YouTube Data API v3 (멤버명+키리누키/클립/切り抜き 검색), 수집 2026-09-05
- 공식 채널 제외 후 팬 제작 클립만 집계: 클립 314개 · 팬채널 80개
- 필터: 제목/채널명 키리누키·클립 토큰

## 한눈에

- **팬 클립 총 조회수 1위**: 텐코 시부키 — 5.0M (23개 클립)
