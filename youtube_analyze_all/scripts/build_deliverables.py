...
PROJECTS = [
    ...
    ("04_kirinuki_ecosystem", 4, "키리누키(2차창작) 생태계", False,
     ...
     "저변의 넓이에 좌우되기 때문이다. 표본 합계 조회수 20.4M 은 공식 채널 조회수에 비하면 "
     "작지만, **아무도 돈을 받지 않고 만든 것**이라는 점에서 팬덤 활성도의 직접 지표다."),
    ...
    ("10_hoyoverse", 10, "호요버스 캐릭터 인기도", False,
     ...
     "리뷰 언급량 1위가 일치하지 않는다. 다만 매칭 가능한 199명 중 72명은 수집된 리뷰에 "
    ...
    ("11_fan_commerce", 11, "팬 커머스", False,
     "팬은 돈을 쓰지만 회사에 남지 않는다. 팬딩 월 구독 중앙값은 7,200원인데 크라우드펀딩 "
     "1인당 후원액은 24.8만원으로 **약 34배**다 — 같은 팬이 정기 구독에는 만원 미만을, "
