...
CREATE TABLE characters (
    ...
    comment_mentions REAL,
    youtube_mentions REAL,
    apple_mentions REAL,
    hoyolab_mentions REAL,
    comment_rate_per_10k REAL,
    mentions_total REAL,
    mentions_common REAL,
    common_sample_n INTEGER,
    mentions_common_per_10k REAL,
    game_avg_score REAL,
