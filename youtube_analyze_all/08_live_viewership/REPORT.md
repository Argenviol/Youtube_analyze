...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-16T02:12 (UTC), 약 92.3시간 / 스냅샷 132시점 · 1451건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +783명 (일 환산 +204명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 180건 (기준 5건), 실관측 22.0시간 (기준 24시간) — 달력 구간은 92.3시간이지만 커버리지 24%, 최대 단절 11.3시간
