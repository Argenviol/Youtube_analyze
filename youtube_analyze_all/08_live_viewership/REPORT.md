...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-14T20:13 (UTC), 약 62.3시간 / 스냅샷 78시점 · 857건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +551명 (일 환산 +212명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 107건 (기준 5건), 실관측 13.0시간 (기준 24시간) — 달력 구간은 62.3시간이지만 커버리지 21%, 최대 단절 11.3시간
