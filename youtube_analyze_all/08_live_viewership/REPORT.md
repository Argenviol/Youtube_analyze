...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-15T15:55 (UTC), 약 82.0시간 / 스냅샷 113시점 · 1242건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +747명 (일 환산 +219명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 170건 (기준 5건), 실관측 18.8시간 (기준 24시간) — 달력 구간은 82.0시간이지만 커버리지 23%, 최대 단절 11.3시간
