...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-13T05:22 (UTC), 약 23.4시간 / 스냅샷 45시점 · 494건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +215명 (일 환산 +220명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 12건 (기준 5건), 실관측 7.5시간 (기준 24시간) — 달력 구간은 23.4시간이지만 커버리지 32%, 최대 단절 11.3시간
