...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-13T18:13 (UTC), 약 36.3시간 / 스냅샷 56시점 · 615건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +486명 (일 환산 +321명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 61건 (기준 5건), 실관측 9.3시간 (기준 24시간) — 달력 구간은 36.3시간이지만 커버리지 26%, 최대 단절 11.3시간
