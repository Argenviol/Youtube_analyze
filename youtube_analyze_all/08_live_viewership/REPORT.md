...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-13T16:14 (UTC), 약 34.3시간 / 스냅샷 54시점 · 593건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +468명 (일 환산 +327명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 58건 (기준 5건), 실관측 9.0시간 (기준 24시간) — 달력 구간은 34.3시간이지만 커버리지 26%, 최대 단절 11.3시간
