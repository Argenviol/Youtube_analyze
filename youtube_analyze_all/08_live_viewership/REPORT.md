...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-15T03:26 (UTC), 약 69.5시간 / 스냅샷 89시점 · 978건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +559명 (일 환산 +193명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 107건 (기준 5건), 실관측 14.8시간 (기준 24시간) — 달력 구간은 69.5시간이지만 커버리지 21%, 최대 단절 11.3시간
