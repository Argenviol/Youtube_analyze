...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-15T07:41 (UTC), 약 73.8시간 / 스냅샷 96시점 · 1055건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +593명 (일 환산 +193명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 116건 (기준 5건), 실관측 16.0시간 (기준 24시간) — 달력 구간은 73.8시간이지만 커버리지 22%, 최대 단절 11.3시간
