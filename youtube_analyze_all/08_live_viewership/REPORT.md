# 프로젝트 8 · StelLive 동시시청자 시계열 분석 (2026-08-18 기준)

- 데이터 소스: 치지직 비공식 API (polling live-status) — 10분 간격 자체 수집
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-18T04:19 (UTC), 약 142.4시간 / 스냅샷 215시점 · 2364건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 아오쿠모 린 — +1,129명 (일 환산 +190명)
- **피크 동시시청자 1위**: 아야츠노 유니 — 8,239명
- 관측된 방송 세션: 68건
- **팬덤 밀도 1위**: 하나코 나나 — 팔로워 1,000명당 36.4명 동시 시청
