...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-13T14:07 (UTC), 약 32.2시간 / 스냅샷 52시점 · 571건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +426명 (일 환산 +318명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 48건 (기준 5건), 실관측 8.7시간 (기준 24시간) — 달력 구간은 32.2시간이지만 커버리지 27%, 최대 단절 11.3시간
