...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-15T11:29 (UTC), 약 77.6시간 / 스냅샷 104시점 · 1143건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +662명 (일 환산 +205명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 147건 (기준 5건), 실관측 17.3시간 (기준 24시간) — 달력 구간은 77.6시간이지만 커버리지 22%, 최대 단절 11.3시간
