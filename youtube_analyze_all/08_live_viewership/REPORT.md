...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-15T19:31 (UTC), 약 85.6시간 / 스냅샷 120시점 · 1319건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +770명 (일 환산 +216명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 180건 (기준 5건), 실관측 20.0시간 (기준 24시간) — 달력 구간은 85.6시간이지만 커버리지 23%, 최대 단절 11.3시간
