...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-13T03:34 (UTC), 약 21.6시간 / 스냅샷 44시점 · 483건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +198명 (일 환산 +220명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 11건 (기준 5건), 실관측 7.3시간 (기준 24시간) — 달력 구간은 21.6시간이지만 커버리지 34%, 최대 단절 11.3시간
