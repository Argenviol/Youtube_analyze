...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-14T05:57 (UTC), 약 48.0시간 / 스냅샷 65시점 · 714건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +510명 (일 환산 +255명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 62건 (기준 5건), 실관측 10.8시간 (기준 24시간) — 달력 구간은 48.0시간이지만 커버리지 23%, 최대 단절 11.3시간
