...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-16T05:16 (UTC), 약 95.3시간 / 스냅샷 136시점 · 1495건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +804명 (일 환산 +202명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 180건 (기준 5건), 실관측 22.7시간 (기준 24시간) — 달력 구간은 95.3시간이지만 커버리지 24%, 최대 단절 11.3시간
