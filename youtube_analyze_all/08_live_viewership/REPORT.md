...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-16T07:07 (UTC), 약 97.2시간 / 스냅샷 139시점 · 1528건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +831명 (일 환산 +205명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 184건 (기준 5건), 실관측 23.2시간 (기준 24시간) — 달력 구간은 97.2시간이지만 커버리지 24%, 최대 단절 11.3시간
