...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-13T06:57 (UTC), 약 25.0시간 / 스냅샷 46시점 · 505건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +252명 (일 환산 +242명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 13건 (기준 5건), 실관측 7.7시간 (기준 24시간) — 달력 구간은 25.0시간이지만 커버리지 31%, 최대 단절 11.3시간
