...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-14T04:24 (UTC), 약 46.5시간 / 스냅샷 64시점 · 703건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +504명 (일 환산 +260명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 62건 (기준 5건), 실관측 10.7시간 (기준 24시간) — 달력 구간은 46.5시간이지만 커버리지 23%, 최대 단절 11.3시간
