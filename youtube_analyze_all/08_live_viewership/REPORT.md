...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-13T22:59 (UTC), 약 41.1시간 / 스냅샷 61시점 · 670건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +492명 (일 환산 +288명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 62건 (기준 5건), 실관측 10.2시간 (기준 24시간) — 달력 구간은 41.1시간이지만 커버리지 25%, 최대 단절 11.3시간
