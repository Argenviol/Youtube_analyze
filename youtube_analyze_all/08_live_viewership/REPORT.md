...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-15T17:51 (UTC), 약 83.9시간 / 스냅샷 117시점 · 1286건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +766명 (일 환산 +219명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 177건 (기준 5건), 실관측 19.5시간 (기준 24시간) — 달력 구간은 83.9시간이지만 커버리지 23%, 최대 단절 11.3시간
