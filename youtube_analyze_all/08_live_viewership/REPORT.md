...
- 관측 구간: 2026-08-12T05:55 ~ 2026-08-13T19:30 (UTC), 약 37.6시간 / 스냅샷 57시점 · 626건
- 멤버 11명
...
- **관측 구간 팔로워 증가 1위**: 강지 — +489명 (일 환산 +312명)

## ⚠ 라이브 분석은 아직 커버리지 미달

- 관측된 방송 세션 62건 (기준 5건), 실관측 9.5시간 (기준 24시간) — 달력 구간은 37.6시간이지만 커버리지 25%, 최대 단절 11.3시간
