...
- **가장 크게 터지는 이벤트는 합방이 아니라 신의상 공개다.** 조회수는 평소의
  **3.6~6.3배**(합방은 1.5~2.7배), 동시시청자 피크는
  **0.8~15.0배**(같은 기간 나란히 돌던 10인 마인크래프트 합방은
  0.8~2.3배)였다. 사키하네 후야의 첫 신의상은 38,402명 — 평소 피크의 19배다.
- **천장이 가장 높은 건 오리지널곡이다.** MV 가 일반 영상의 0.6~27.3배,
  같은 멤버의 커버곡과 비교해도 0.2~9.0배다. 다만 잴 수 있는 곡이
...
- **콘서트는 단독이냐 합동이냐로 갈린다.** 본인 첫 단독 콘서트의 후기 방송은 평소의
  6.0배(안내 쇼츠 81,867회)였지만, 같은 멤버가 참여한 그룹 페스티벌은
...
|---|---|---|---|---|
| 오리지널곡 MV | 유튜브 조회수 | 일반 영상의 1~27배 | ✅ | 잴 수 있는 곡이 한 앨범 4곡 |
...
| 대규모 합방 | 조회수(분량으로) | 1.5~2.7배 · 동시시청자 0.8~2.3배 | ✅ | 연속 2일 이상만 이벤트로 인정 |
...
| 채널 성과 | 유튜브 조회수·성장 | 업로드 빈도 → 조회수 +0.58 · 규모 → 성장 -0.67 | ✅ | n=10 상관 |
...
| 지표 | 신의상 공개 | 대규모 합방 |
|---|---|---|
| VOD 조회수 배수 | **3.6~6.3배** | 1.5~2.7배 |
| 동시시청자 피크 배수 | **0.8~15.0배** | 0.8~2.3배 |

| 멤버 | 공개일 피크 | 평소 피크 | 배수 |
|---|---|---|---|
| 사키하네 후야 | 38,402 | 2,556 | **15.02배** |
| 네네코 마시로 | 28,071 | 3,137 | **8.95배** |
| 아라하시 타비 | 38,237 | 4,488 | **8.52배** |
| 하나코 나나 | 24,385 | 3,253 | **7.50배** |
| 시라유키 히나 | 4,448 | 3,825 | **1.16배** |
| 유즈하 리코 | 3,503 | 3,148 | **1.11배** |
...
|---|---|---|---|---|---|---|
| Maid My Way | 아오쿠모 린 | 2026-07-27 | 2,644,909 (MV 2,014,082 + 음원 630,827) | 97,007 | **27.3배** | 2.8배 |
| 악당주의보 | 유즈하 리코 | 2026-07-24 | 1,543,008 (음원 판 없음) | 136,706 | **11.3배** | 9.0배 |
| Berry Verry Strawberry | 텐코 시부키 | 2026-07-25 | 375,975 (음원 판 없음) | 150,323 | **2.5배** | 1.1배 |
| Hush Trap | 하나코 나나 | 2026-07-26 | 79,022 (음원 판 없음) | 132,524 | **0.6배** | 0.2배 |

오리지널곡 MV 는 그 멤버의 일반 영상보다 **0.6~27.3배** 본다. 같은 멤버의
커버곡과 비교해도 **0.2~9.0배**다. 지금까지 잰 이벤트 중 단일 콘텐츠로는
천장이 가장 높다.
...
|---|---|---|---|---|
| 아오쿠모 린 | 2곡 | 948,211 | 108,542 | **8.74배** |
| 아라하시 타비 | 1곡 | 839,373 | 111,423 | **7.53배** |
| 시라유키 히나 | 1곡 | 466,662 | 99,472 | **4.69배** |
| 아야츠노 유니 | 1곡 | 399,240 | 93,097 | **4.29배** |
| 사키하네 후야 | 2곡 | 354,240 | 83,494 | **4.24배** |
| 하나코 나나 | 3곡 | 468,651 | 122,566 | **3.82배** |
| 네네코 마시로 | 3곡 | 188,998 | 64,637 | **2.92배** |
| 텐코 시부키 | 1곡 | 338,928 | 147,858 | **2.29배** |
| 아카네 리제 | 1곡 | 258,754 | 212,546 | **1.22배** |
| 유즈하 리코 | 8곡 | 172,163 | 184,760 | **0.93배** |

커버곡은 그 멤버의 일반 영상보다 **중앙값 4.0배** 본다. 10명 중 9명이 2.8~7.4배에
들어간다.

**콜라보 커버가 더 잘 되지는 않는다.** 2026년 커버만 놓고 보면 솔로 398,997회 ·
콜라보 391,012회로 차이가 없다. 전체 기간으로는 콜라보가 높아 보이는데, 콜라보 커버가
...
|---|---|---|---|---|---|
| 2026-07-11 아카네 리제 첫 단독 콘서트 | 아카네 리제 | 4건 | 13,784 | 2,310 | **5.97배** |
...
| 2025-12-20 2025 THE 1ST STELLIVE  | 유즈하 리코 | 1건 | 5,060 | 4,194 | **1.21배** |
| 2025-12-20 2025 THE 1ST STELLIVE  | 아카네 리제 | 7건 | 3,944 | 3,280 | **1.20배** |
| 2025-12-20 2025 THE 1ST STELLIVE  | 하나코 나나 | 1건 | 3,976 | 3,794 | **1.05배** |

**본인 단독 콘서트가 그룹 합동보다 훨씬 크게 남는다.** 아카네 리제의 첫 단독 콘서트
후기 방송은 평소의 6.0배였고, 콘서트 안내 쇼츠는 **81,867회**로 그 채널
...
|---|---|---|---|---|---|---|
| 사키하네 후야 | 135,000 | 118,818 | 3.5 | 22% | 4.0% | **+3.85%** |
| 유즈하 리코 | 222,000 | 284,394 | 5.5 | 40% | 3.5% | **+3.74%** |
| 하나코 나나 | 207,000 | 181,668 | 6.5 | 52% | 4.1% | **+2.99%** |
| 아오쿠모 린 | 284,000 | 201,337 | 4.2 | 22% | 3.4% | **+2.90%** |
| 아라하시 타비 | 262,000 | 216,790 | 4.0 | 18% | 3.1% | **+2.75%** |
| 텐코 시부키 | 230,000 | 189,787 | 6.5 | 48% | 3.9% | **+2.68%** |
| 아카네 리제 | 356,000 | 270,943 | 5.0 | 40% | 3.2% | **+2.59%** |
| 네네코 마시로 | 184,000 | 121,173 | 2.0 | 8% | 4.3% | **+2.22%** |
| 아야츠노 유니 | 361,000 | 139,996 | 2.9 | 16% | 3.4% | **+0.84%** |
| 시라유키 히나 | 320,000 | 180,407 | 3.4 | 38% | 3.4% | **+0.31%** |
...
**업로드 빈도와 평균 조회수의 상관 +0.58** — 이 규모대에서는 물량이 조회수를
...
|---|---|---|---|---|---|---|---|
| 사키하네 후야 | 165,799 | 26h | 5.0h | 38% | 31% | 3,597 | **+5.67%** |
| 유즈하 리코 | 218,127 | 34h | 7.0h | 67% | 38% | 4,542 | **+4.02%** |
| 하나코 나나 | 215,637 | 23h | 5.3h | 52% | 74% | 3,973 | **+3.85%** |
| 아오쿠모 린 | 227,325 | 21h | 4.7h | 65% | 87% | 3,987 | **+3.68%** |
| 아카네 리제 | 261,307 | 23h | 5.0h | 65% | 52% | 3,763 | **+3.24%** |
| 네네코 마시로 | 216,660 | 25h | 4.8h | 22% | 42% | 3,349 | **+3.22%** |
| 아라하시 타비 | 263,403 | 39h | 7.4h | 67% | 51% | 5,592 | **+3.09%** |
| 텐코 시부키 | 248,163 | 35h | 7.1h | 81% | 72% | 6,848 | **+2.83%** |
| 아야츠노 유니 | 307,844 | 36h | 6.3h | 46% | 27% | 3,848 | **+1.93%** |
| 시라유키 히나 | 241,140 | 36h | 6.2h | 71% | 39% | 5,856 | **+1.72%** |
...
### ② 스텔라이브 접점 — 방송 56건 / 2971건 (1.9%)

| 멤버 | 게임 | 방송 | 호요 방송 중앙 | 평소 중앙 | 배수 | [광고] | 광고 배수 | 비광고 배수 |
|---|---|---|---|---|---|---|---|---|
| 아카네 리제 | 붕괴: 스타레일 | 21회 | 5,794 | 2,935 | **1.97배** | 3회 | 1.12배 | 2.12배 |
| 하나코 나나 | 붕괴: 스타레일 | 17회 | 4,214 | 3,147 | **1.34배** | 5회 | 1.10배 | 1.40배 |
| 유즈하 리코 | 젠레스 존 제로 | 8회 | 4,382 | 3,965 | **1.11배** | 3회 | 0.91배 | 1.14배 |
| 사키하네 후야 | 젠레스 존 제로 | 7회 | 1,946 | 2,271 | **0.86배** | 1회 | 1.41배 | 0.77배 |

방송 3회 이상인 멤버 4명 중 **아카네 리제만 평소보다 확실히 더 본다**(1.97배, 붕괴: 스타레일 21회). 나머지는 하나코 나나 1.34배·유즈하 리코 1.11배·사키하네 후야 0.86배로 평소와 같거나 낮다. 게임 자체가 시청자를 끌지는 않고, 그 멤버의 주력 콘텐츠일 때만 세다. 또 하나 — **[광고] 방송은 같은 게임의 비광고 방송보다 덜 본다.** 광고 2회 이상인 3명 중 3명이 그렇고(아카네 리제 1.12배 vs 2.12배·하나코 나나 1.10배 vs 1.40배·유즈하 리코 0.91배 vs 1.14배), 광고 방송은 게임을 '하는' 게 아니라 '보여주는' 방송이라 시청자가 덜 붙는 것으로 읽힌다.
...
|---|---|---|---|
| StelLive | 246,000 | **0.77** | 3.4% |
| 이세계아이돌 | 415,000 | **0.23** | 5.0% |
...
|---|---|---|---|---|---|---|
| 텐코 시부키 | 21편 | 5,181,520 | 145,431 | 161,402 | 0.90배 | 14개 |
| 시라유키 히나 | 30편 | 2,640,011 | 27,857 | 116,966 | 0.24배 | 19개 |
| 아야츠노 유니 | 28편 | 2,327,358 | 6,155 | 100,553 | 0.06배 | 13개 |
| 아카네 리제 | 23편 | 2,161,274 | 5,514 | 226,581 | 0.02배 | 9개 |
| 네네코 마시로 | 43편 | 2,034,544 | 5,385 | 74,675 | 0.07배 | 12개 |
| 아라하시 타비 | 43편 | 1,200,928 | 10,576 | 122,336 | 0.09배 | 12개 |
| 하나코 나나 | 17편 | 983,404 | 16,665 | 129,406 | 0.13배 | 11개 |
| 아오쿠모 린 | 6편 | 492,743 | 42,065 | 110,690 | 0.38배 | 3개 |
| 유즈하 리코 | 6편 | 373,909 | 12,414 | 178,779 | 0.07배 | 5개 |
| 사키하네 후야 | 28편 | 91,984 | 2,442 | 85,265 | 0.03배 | 4개 |
...
관측된 방송 세션 952건의 피크 분포는 심하게 치우쳐 있다 — 중앙값 **3,606명**, 상위 5% 7,457명, 상위 1% 11,075명, 최대 **38,402명**. 평균 근처에 몰려 있는 게 아니라 꼬리가 길다.
...
|---|---|---|---|---|---|
| 2026-08-31 | 스텔 여름 휴가 신의상 릴레이 공개 (9명) | 사키하네 후야 | 38,402 | 2,556 | 15.02배 |
| 2026-08-31 | 스텔 여름 휴가 신의상 릴레이 공개 (9명) | 네네코 마시로 | 28,071 | 3,137 | 8.95배 |
| 2026-08-31 | 스텔 여름 휴가 신의상 릴레이 공개 (9명) | 아라하시 타비 | 38,237 | 4,488 | 8.52배 |
...
| 2026-08-29 | 마인크래프트 | 사키하네 후야 | 4,734 | 2,478 | 1.91배 |
