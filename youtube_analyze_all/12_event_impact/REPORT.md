...
- 이벤트 구간: 2017-06-01 ~ 2026-09-18 · 총 409건
- 구성: 커버곡 370건, 오리지널곡 18건, 합방 11건, 신의상 4건, 팬펀딩 4건, 콘서트 2건
...
- **대규모 컨텐츠 11건**을 자동 감지했다 — 4명 이상이 **연속 2일 이상**
  ...
  기획이 그대로 잡힌다.
- 그 11건 중 **14건이 평소 방송 대비 1.5배 이상**의 조회수를 냈다.
  하루짜리를 섞었을 때는 이 비율이 절반 수준이었다 — **연속 기획만 남기면 효과가 선명해진다.**
  단발 합방과 며칠짜리 기획은 성격이 다른 이벤트다.
- **가장 크게 터지는 이벤트는 합방이 아니라 신의상 공개다.** 조회수는 평소의
  **3.6~6.2배**(합방은 1.5~2.6배), 동시시청자 피크는
  **0.8~15.5배**(같은 기간 나란히 돌던 10인 마인크래프트 합방은
  0.8~2.3배)였다. 사키하네 후야의 첫 신의상은 38,402명 — 평소 피크의 19배다.
- **천장이 가장 높은 건 오리지널곡이다.** MV 가 일반 영상의 7.8~29.6배,
  같은 멤버의 커버곡과 비교해도 1.9~9.0배다. 다만 잴 수 있는 곡이
...
- **콘서트는 단독이냐 합동이냐로 갈린다.** 본인 첫 단독 콘서트의 후기 방송은 평소의
  6.0배(안내 쇼츠 81,849회)였지만, 같은 멤버가 참여한 그룹 페스티벌은
  1.1~2.7배였다. 합동은 관심이 10명에게 나뉜다.
- **게임사의 공식 푸시는 유저 언급을 만들지 못한다**(상관 -0.04). 희귀도(5성)는
  효과가 있지만 푸시 순서는 없고, 인기는 구작 5성에 쌓여 있다. 스텔라이브 접점은 방송의
  1.9%뿐이며, 게임이 시청자를 끄는 게 아니라 그 멤버의 주력일 때만 평소를 넘는다.
- **같은 38일에 스텔라이브만 전원이 올랐다.** 구독자 +0명으로 11분의 1 규모의
  홀로라이브(+0명)와 같은 수를 더했고, 이세계아이돌은 전원 감소했다. 커버가 내는
...
- **키리누키는 유일하게 기획할 수 없는 이벤트다.** 클립 표본의 78%가 어떤
  이벤트 키워드에도 안 걸린다 — 클립이 되는 건 기획이 아니라 방송 중 우연한 순간이다.
  개별 클립은 본인 영상의 8% 수준이지만 공식 채널 밖 도달이고,
  상위 3개 채널이 조회수의 36%를 가져간다.
...
|---|---|---|---|---|
| 오리지널곡 MV | 유튜브 조회수 | 일반 영상의 8~30배 | ✅ | 잴 수 있는 곡이 한 앨범 4곡 |
| 신의상 공개 | 치지직 동시시청자 | 평소 피크의 1~15배 (조회수 3.6~6.2배) | ✅ | 연 몇 회짜리 희소 이벤트 |
...
| 키리누키 | 공식 채널 밖 도달 | 클립당 본인 영상의 8% | ❌ 순간이 만든다 | 검색 표본, 비율은 상한 |
...
| 경쟁사 비교 | 같은 기간 성장 | 스텔라이브 +0 vs 홀로 +0 (11분의 1 규모) | — | 21일 · 1,000 반올림 |
| 호요버스 | 공식 푸시 → 언급 | 상관 -0.04 (없음) | — | 언급은 인기가 아니라 화제성 |
| 채널 성과 | 유튜브 조회수·성장 | 업로드 빈도 → 조회수 +0.68 · 규모 → 성장 -0.67 | ✅ | n=10 상관 |
| 방송 패턴 | 치지직 VOD·성장 | 시간·심야 → VOD +0.7, 성장은 규모에 딸림 | ✅ | n=10 상관 |
| 시장 | 배경 속도 | 시장 연 10%~16% vs 스텔라이브 47일 +3.3% | — | 한 달 연환산은 거칠다 |
...
| 날짜 | 이벤트 | 참여자 평균 배수 |
|---|---|---|
| 2026-08-31 | 스텔 여름 휴가 신의상 릴레이 공개 (9명) | 6.22배 |
...
| 지표 | 신의상 공개 | 대규모 합방 |
|---|---|---|
| VOD 조회수 배수 | **3.6~6.2배** | 1.5~2.6배 |
| 동시시청자 피크 배수 | **0.8~15.5배** | 0.8~2.3배 |

| 멤버 | 공개일 피크 | 평소 피크 | 배수 |
|---|---|---|---|
| 사키하네 후야 | 38,402 | 2,478 | **15.49배** |
| 네네코 마시로 | 28,071 | 3,137 | **8.95배** |
| 아라하시 타비 | 38,237 | 4,483 | **8.53배** |
| 하나코 나나 | 24,385 | 3,253 | **7.50배** |
| 시라유키 히나 | 4,448 | 3,788 | **1.17배** |
| 유즈하 리코 | 3,503 | 3,145 | **1.11배** |
| 아야츠노 유니 | 3,032 | 3,920 | **0.77배** |
...
| 곡 | 멤버 | 공개일 | MV + 음원 조회수 | 일반 중앙 | 일반 대비 | 커버 대비 |
|---|---|---|---|---|---|---|
| Maid My Way | 아오쿠모 린 | 2026-07-27 | 2,627,630 (MV 2,002,337 + 음원 625,293) | 88,872 | **29.6배** | 2.8배 |
| 악당주의보 | 유즈하 리코 | 2026-07-24 | 1,535,544 (음원 판 없음) | 156,420 | **9.8배** | 9.0배 |
| Hush Trap | 하나코 나나 | 2026-07-26 | 1,021,950 (음원 판 없음) | 129,002 | **7.9배** | 1.9배 |
| Berry Verry Strawberry | 텐코 시부키 | 2026-07-25 | 1,138,330 (음원 판 없음) | 146,790 | **7.8배** | 3.4배 |

오리지널곡 MV 는 그 멤버의 일반 영상보다 **7.8~29.6배** 본다. 같은 멤버의
커버곡과 비교해도 **1.9~9.0배**다. 지금까지 잰 이벤트 중 단일 콘텐츠로는
천장이 가장 높다.
...
읽어야 한다. 유즈하 리코의 커버 대비 배수(9.0배)가 유독 큰 것도 곡이 세서가
...
|---|---|---|---|---|
| 아오쿠모 린 | 2곡 | 940,880 | 106,973 | **8.80배** |
| 아라하시 타비 | 1곡 | 826,914 | 111,246 | **7.43배** |
| 시라유키 히나 | 2곡 | 502,553 | 114,564 | **4.39배** |
| 하나코 나나 | 2곡 | 534,549 | 121,843 | **4.39배** |
| 아야츠노 유니 | 1곡 | 397,439 | 92,983 | **4.27배** |
| 사키하네 후야 | 2곡 | 350,626 | 83,333 | **4.21배** |
| 네네코 마시로 | 3곡 | 188,189 | 63,450 | **2.97배** |
| 텐코 시부키 | 1곡 | 332,880 | 146,790 | **2.27배** |
| 아카네 리제 | 1곡 | 255,829 | 198,238 | **1.29배** |
| 유즈하 리코 | 8곡 | 170,225 | 188,725 | **0.90배** |

커버곡은 그 멤버의 일반 영상보다 **중앙값 4.2배** 본다. 10명 중 9명이 2.8~7.4배에
들어간다.

**콜라보 커버가 더 잘 되지는 않는다.** 2026년 커버만 놓고 보면 솔로 396,049회 ·
콜라보 389,111회로 차이가 없다. 전체 기간으로는 콜라보가 높아 보이는데, 콜라보 커버가
**2024년부터만 존재해서** 생기는 착시다(그 이전 카탈로그는 전부 솔로).

### 읽을 때 주의

유즈하 리코만 0.90배로 유일하게 1배 미만이고, 동시에 커버를 가장 자주 올린다
...
|---|---|---|---|---|---|
| 2026-07-11 아카네 리제 첫 단독 콘서트 | 아카네 리제 | 4건 | 13,771 | 2,309 | **5.96배** |
| 2025-12-20 2025 THE 1ST STELLIVE  | 시라유키 히나 | 2건 | 11,463 | 4,273 | **2.68배** |
| 2025-12-20 2025 THE 1ST STELLIVE  | 사키하네 후야 | 1건 | 3,551 | 2,728 | **1.30배** |
| 2025-12-20 2025 THE 1ST STELLIVE  | 유즈하 리코 | 1건 | 5,058 | 4,192 | **1.21배** |
| 2025-12-20 2025 THE 1ST STELLIVE  | 아카네 리제 | 7건 | 3,944 | 3,279 | **1.20배** |
| 2025-12-20 2025 THE 1ST STELLIVE  | 하나코 나나 | 1건 | 3,976 | 3,794 | **1.05배** |

**본인 단독 콘서트가 그룹 합동보다 훨씬 크게 남는다.** 아카네 리제의 첫 단독 콘서트
후기 방송은 평소의 6.0배였고, 콘서트 안내 쇼츠는 **81,849회**로 그 채널
...
|---|---|---|---|---|---|---|
| 사키하네 후야 | 135,000 | 118,104 | 3.5 | 22% | 4.0% | **+3.85%** |
| 유즈하 리코 | 222,000 | 298,804 | 5.6 | 42% | 3.6% | **+3.74%** |
| 하나코 나나 | 207,000 | 196,736 | 6.5 | 50% | 4.1% | **+2.99%** |
| 아오쿠모 린 | 284,000 | 199,955 | 4.2 | 22% | 3.4% | **+2.90%** |
| 아라하시 타비 | 262,000 | 215,287 | 4.0 | 18% | 3.1% | **+2.75%** |
| 텐코 시부키 | 230,000 | 205,638 | 6.2 | 46% | 3.9% | **+2.68%** |
| 아카네 리제 | 356,000 | 267,563 | 5.0 | 40% | 3.2% | **+2.59%** |
| 네네코 마시로 | 184,000 | 120,137 | 2.0 | 8% | 4.4% | **+2.22%** |
| 아야츠노 유니 | 361,000 | 139,026 | 2.9 | 16% | 3.4% | **+0.84%** |
| 시라유키 히나 | 320,000 | 189,558 | 3.5 | 38% | 3.4% | **+0.31%** |

| 요인 | → 평균 조회수 | → 38일 구독자 성장 |
|---|---|---|
| 주당 업로드 | +0.68 | +0.44 |
| 쇼츠 비중 | +0.63 | +0.16 |
| 참여율 | -0.52 | +0.24 |
...
**업로드 빈도와 평균 조회수의 상관 +0.68** — 이 규모대에서는 물량이 조회수를
...
|---|---|---|---|---|---|---|---|
| 사키하네 후야 | 165,641 | 26h | 5.0h | 38% | 31% | 3,597 | **+5.67%** |
| 유즈하 리코 | 217,760 | 34h | 7.0h | 67% | 38% | 4,537 | **+4.02%** |
| 하나코 나나 | 215,413 | 23h | 5.3h | 52% | 74% | 3,975 | **+3.85%** |
| 아오쿠모 린 | 227,179 | 21h | 4.7h | 65% | 87% | 3,986 | **+3.68%** |
| 아카네 리제 | 261,082 | 23h | 5.0h | 65% | 52% | 3,761 | **+3.23%** |
| 네네코 마시로 | 216,584 | 25h | 4.8h | 22% | 42% | 3,345 | **+3.22%** |
| 아라하시 타비 | 263,207 | 39h | 7.4h | 66% | 51% | 5,591 | **+3.09%** |
| 텐코 시부키 | 247,933 | 36h | 7.1h | 81% | 71% | 6,862 | **+2.83%** |
| 아야츠노 유니 | 307,739 | 36h | 6.4h | 46% | 26% | 3,890 | **+1.93%** |
| 시라유키 히나 | 240,915 | 36h | 6.1h | 71% | 39% | 5,885 | **+1.72%** |

| 요인 | → 평균 VOD 조회수 | → 38일 팔로워 성장 |
|---|---|---|
| 주당 방송 시간 | +0.71 | -0.52 |
| 평균 방송 길이 | +0.75 | -0.37 |
| 심야 비중 | +0.77 | -0.32 |
...
스텔라이브 탤런트 10명의 유튜브 구독자 합계는 2026-08-03 2,480,000 → 2026-09-19 2,561,000
(**+3.27%**, 47일)이다. 단순 연환산하면 +28%로 시장 성장률의 몇 배지만,
...
매칭 가능한 캐릭터 297명 중 42%만 리뷰에 한 번이라도 언급된다.
공식 푸시 순위(5성·최신순)와 언급률의 상관은 게임별로 **붕괴3rd +0.18 · 붕괴:스타레일 -0.06 · 원신 -0.29 · 젠레스 존 제로 +0.02** (평균 -0.04) — 없다.
출시 최신순과의 상관도 평균 +0.12로 약하다. 순위는 게임 안에서만 매긴 값이라
...
|---|---|---|---|---|---|
| 붕괴:스타레일 | 키레네 | 2025-11-05 | **18** | 13위 | -0.59 |
| 젠레스 존 제로 | 엽빛나 | 2025-12-30 | **14** | 14위 | +0.10 |
| 원신 | 콜롬비나 | 2026-01-12 | **13** | 8위 | +0.58 |
| 원신 | 산드로네 | 2026-06-29 | **12** | 2위 | +0.10 |
| 원신 | 푸리나 | 2023-11-06 | **11** | 31위 | +0.99 |
| 젠레스 존 제로 | 제인 | 2024-09-04 | **11** | 37위 | -1.08 |
| 붕괴:스타레일 | 파이논 | 2025-07-02 | **10** | 20위 | -0.56 |
| 젠레스 존 제로 | 엘렌 | 2024-07-04 | **10** | 45위 | +1.50 |

언급 상위 8명의 푸시 순위 중앙값은 **17위**(낮을수록 강한 푸시)이고 출시는
대부분 1~2년 전이다. 반대로 지금 가장 세게 미는 5명의 언급 중앙값은 **0건**
(상위 8명은 12건)이며 감성은 게임 평균보다 낮은 쪽이 많다. **인기는 구작
5성에 쌓여 있고, 신작 푸시는 언급을 만들지 못한 채 불만만 만든다.**

### ② 스텔라이브 접점 — 방송 56건 / 2970건 (1.9%)

| 멤버 | 게임 | 방송 | 호요 방송 중앙 | 평소 중앙 | 배수 | [광고] | 광고 배수 | 비광고 배수 |
|---|---|---|---|---|---|---|---|---|
| 아카네 리제 | 붕괴: 스타레일 | 21회 | 5,794 | 2,935 | **1.97배** | 3회 | 1.12배 | 2.12배 |
| 하나코 나나 | 붕괴: 스타레일 | 17회 | 4,214 | 3,148 | **1.34배** | 5회 | 1.10배 | 1.40배 |
| 유즈하 리코 | 젠레스 존 제로 | 8회 | 4,382 | 3,961 | **1.11배** | 3회 | 0.91배 | 1.15배 |
| 사키하네 후야 | 젠레스 존 제로 | 7회 | 1,945 | 2,270 | **0.86배** | 1회 | 1.41배 | 0.77배 |

방송 3회 이상인 멤버 4명 중 **아카네 리제만 평소보다 확실히 더 본다**(1.97배, 붕괴: 스타레일 21회). 나머지는 하나코 나나 1.34배·유즈하 리코 1.11배·사키하네 후야 0.86배로 평소와 같거나 낮다. 게임 자체가 시청자를 끌지는 않고, 그 멤버의 주력 콘텐츠일 때만 세다. 또 하나 — **[광고] 방송은 같은 게임의 비광고 방송보다 덜 본다.** 광고 2회 이상인 3명 중 3명이 그렇고(아카네 리제 1.12배 vs 2.12배·하나코 나나 1.10배 vs 1.40배·유즈하 리코 0.91배 vs 1.15배), 광고 방송은 게임을 '하는' 게 아니라 '보여주는' 방송이라 시청자가 덜 붙는 것으로 읽힌다.
...
### 같은 기간 성장 (2026-08-12 → 2026-09-19, 38일)
...
|---|---|---|---|
| StelLive | 3.9편 | **8.0%** (24편) | 1.95배 |
| 이세계아이돌 | 3.5편 | **0.0%** (0편) | 커버 없음 |

스텔라이브는 세 그룹 중 **업로드는 가장 적게 하면서 커버 비중은 가장 높다.** 그리고
커버가 일반 영상 대비 내는 배수는 비교 불가 — **커버라는 레버 자체는 그룹을 가리지
...
⚠ **38일·그룹당 6명·1,000 단위 반올림**이다. 홀로라이브 270만 채널은 +999명이
늘어도 0으로 보이므로 상대 성장률 비교는 스텔라이브에 유리하다. 절대 증가로는
스텔라이브 +0명 · 홀로라이브 +0명으로 **11분의 1 규모에서 같은
수를 더했다**가 정확한 진술이다.
...
멤버별 감성 점수(0.33~0.93)와 최근 21일 치지직 팔로워 성장률의 상관은 **+0.29**(n=10)다. 방향이 있다고 말할 수준이 아니다. 점수 자체도 멤버 간 차이가 거의 없다 — 최저인 멤버도 표본이 야구 영상에 쏠린 탓이지 여론이 나빠서가 아니다.
...
|---|---|---|---|---|---|---|
| 텐코 시부키 | 21편 | 5,181,520 | 145,431 | 161,079 | 0.90배 | 14개 |
| 시라유키 히나 | 30편 | 2,640,011 | 27,857 | 131,542 | 0.21배 | 19개 |
| 아야츠노 유니 | 28편 | 2,327,358 | 6,155 | 100,133 | 0.06배 | 13개 |
| 아카네 리제 | 23편 | 2,161,274 | 5,514 | 223,074 | 0.02배 | 9개 |
| 네네코 마시로 | 43편 | 2,034,544 | 5,385 | 74,623 | 0.07배 | 12개 |
| 아라하시 타비 | 43편 | 1,200,928 | 10,576 | 119,378 | 0.09배 | 12개 |
| 하나코 나나 | 17편 | 983,404 | 16,665 | 129,865 | 0.13배 | 11개 |
| 아오쿠모 린 | 6편 | 492,743 | 42,065 | 110,607 | 0.38배 | 3개 |
| 유즈하 리코 | 6편 | 373,909 | 12,414 | 180,607 | 0.07배 | 5개 |
| 사키하네 후야 | 28편 | 91,984 | 2,442 | 84,996 | 0.03배 | 4개 |

**클립 하나는 작지만 수가 많고, 공식 채널 밖에 있다.** 클립 조회수 중앙값은 그 멤버
영상의 **8%** 수준이다(멤버별로 2%~67%로 편차가 크다 — 사키하네 후야가
0.02배로 최저인 건 2025-09 데뷔라 클립 생태계가 아직 얇기 때문이고, 텐코 시부키가
0.67배로 최고인 건 역대 1위 클립을 포함한 소수의 큰 클립이 끌어올린 결과다). 대신 멤버당 6~43편이 69개 채널에서
...
| 주제 | 클립 수 | 비중 | 조회수 중앙값 |
|---|---|---|---|
| 커버·노래 | 49편 | 20.0% | 21,564 |
| 게임 | 4편 | 1.6% | 43,826 |
| 합방·서버 | 3편 | 1.2% | 4,056 |
| 신의상 | 1편 | 0.4% | 12,179 |
| **어느 것도 아님** | — | **77.6%** | — |

여기가 다른 이벤트와 갈리는 지점이다. 표본 245건 중 **78%가 어떤
...
클립 245건이 69개 채널에서 나오는데, **상위 3개 채널이 조회수의
36%, 상위 10개가 67%**를 가져간다. 2차창작이 넓게 퍼져 있다기보다
...
관측된 방송 세션 942건의 피크 분포는 심하게 치우쳐 있다 — 중앙값 **3,602명**, 상위 5% 7,445명, 상위 1% 11,201명, 최대 **38,402명**. 평균 근처에 몰려 있는 게 아니라 꼬리가 길다.
...
| 5 | 09-18 | 사키하네 후야 | **21,219** | 통통꼬리 용가리! 사키하네 후야 3D 데뷔! 🐲 |
...
|---|---|---|---|---|---|
| 2026-08-31 | 스텔 여름 휴가 신의상 릴레이 공개 (9명) | 사키하네 후야 | 38,402 | 2,478 | 15.49배 |
...
| 2026-08-29 | 마인크래프트 | 사키하네 후야 | 4,734 | 2,401 | 1.97배 |
