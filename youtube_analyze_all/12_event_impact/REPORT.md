...
- 이벤트 구간: 2017-06-01 ~ 2026-08-25 · 총 394건
- 구성: 커버곡 365건, 오리지널곡 18건, 합방 9건, 콘서트 2건
...
- **대규모 컨텐츠 9건**을 자동 감지했다 — 4명 이상이 **연속 2일 이상**
  함께한 기획만 이벤트로 본다. 마인크래프트 서버·봉켓몬·봉봉팜·팰월드처럼 며칠에 걸친
  기획이 그대로 잡힌다.
- 그 9건 중 **9건이 평소 방송 대비 1.5배 이상**의 조회수를 냈다.
...
- 최근 1건은 **관측 중**이다. 이벤트 후 5일이 지나야 전후 비교를 낸다 —
...
| 날짜 | 이벤트 | 참여자 평균 배수 |
|---|---|---|
| 2025-12-22 | 마인크래프트 · 멋사 | 2.91배 |
| 2026-06-23 | 마인크래프트 · 봉켓몬 · 대한민국 | 2.66배 |
| 2025-10-07 | 마인크래프트 · 마크 | 2.27배 |
