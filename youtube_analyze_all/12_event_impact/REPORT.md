...
- 이벤트 구간: 2017-06-01 ~ 2026-08-27 · 총 399건
- 구성: 커버곡 365건, 합방 33건, 콘서트 1건
...
- 관측 구간 전체에서 **대규모 합방(4명 이상) 33건**을 자동 감지했다.
  마인크래프트 서버·봉켓몬·팰월드·갈틱폰처럼 이름이 붙은 이벤트가 그대로 잡힌다.
- 소급 측정한 합방 중 **16건이 평소 방송 대비 1.5배 이상**의 조회수를 냈다.
...
- 최근 2건은 **관측 중**이다. 이벤트 후 5일이 지나야 전후 비교를 낸다 —
...
| 2026-08-16 | 논브레스 오블리주 [ノンブレス・オブリージュ /  | 하나코 나나 | 2,746 | 3,400 | 0.81배 |
| 2026-08-16 | 데드 바이 데이라이트 | 하나코 나나 | 2,746 | 3,400 | 0.81배 |
| 2026-08-27 | 이터널 리턴 | 아오쿠모 린 | 2,531 | 3,594 | 0.70배 |
| 2026-08-27 | 이터널 리턴 | 유즈하 리코 | 2,174 | 3,839 | 0.57배 |
