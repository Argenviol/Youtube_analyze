...
- 이벤트 구간: 2017-06-01 ~ 2026-09-07 · 총 412건
- 구성: 커버곡 374건, 오리지널곡 18건, 합방 10건, 신의상 4건, 팬펀딩 4건, 콘서트 2건
...
- **대규모 컨텐츠 10건**을 자동 감지했다 — 4명 이상이 **연속 2일 이상**
  ...
  기획이 그대로 잡힌다.
- 그 10건 중 **13건이 평소 방송 대비 1.5배 이상**의 조회수를 냈다.
  하루짜리를 섞었을 때는 이 비율이 절반 수준이었다 — **연속 기획만 남기면 효과가 선명해진다.**
  단발 합방과 며칠짜리 기획은 성격이 다른 이벤트다.
- **가장 크게 터지는 이벤트는 합방이 아니라 신의상 공개다.** 조회수는 평소의
  **3.6~6.9배**(합방은 1.5~2.7배), 동시시청자 피크는
  **0.8~17.6배**(같은 기간 나란히 돌던 10인 마인크래프트 합방은
  0.9~2.4배)였다. 사키하네 후야의 첫 신의상은 38,402명 — 평소 피크의 19배다.
- **천장이 가장 높은 건 오리지널곡이다.** MV 가 일반 영상의 7.4~20.5배,
  같은 멤버의 커버곡과 비교해도 2.2~9.7배다. 다만 잴 수 있는 곡이
  한 앨범(4곡)뿐이라 **경향이 아니라 사례**로 읽어야 한다.
- **커버곡은 평소 영상의 4.3배 본다**(같은 기간·성숙 영상만 비교). 콜라보 커버가
  더 잘 되지는 않는다 — 2026년 기준 솔로와 콜라보의 조회수 중앙값이 같다.
- **콘서트는 단독이냐 합동이냐로 갈린다.** 본인 첫 단독 콘서트의 후기 방송은 평소의
  5.9배(안내 쇼츠 1,733,786회)였지만, 같은 멤버가 참여한 그룹 페스티벌은
...
- **같은 26일에 스텔라이브만 전원이 올랐다.** 구독자 +23,000명으로 11분의 1 규모의
  홀로라이브(+30,000명)와 같은 수를 더했고, 이세계아이돌은 전원 감소했다. 커버가 내는
...
- **키리누키는 유일하게 기획할 수 없는 이벤트다.** 클립 표본의 75%가 어떤
  ...
  개별 클립은 본인 영상의 15% 수준이지만 공식 채널 밖 도달이고,
  상위 3개 채널이 조회수의 29%를 가져간다.
...
- 최근 4건은 **관측 중**이다. 이벤트 후 5일이 지나야 전후 비교를 낸다 —
...
|---|---|---|---|---|
| 오리지널곡 MV | 유튜브 조회수 | 일반 영상의 7~20배 | ✅ | 잴 수 있는 곡이 한 앨범 4곡 |
| 신의상 공개 | 치지직 동시시청자 | 평소 피크의 1~18배 (조회수 3.6~6.9배) | ✅ | 연 몇 회짜리 희소 이벤트 |
| 단독 콘서트 | 주변 방송 조회수 | 5.9배 (합동 페스티벌 1.1~2.7배) | ✅ | 구독자 전후 비교 불가(수집 이전) |
| 커버곡 | 유튜브 조회수 | 일반 영상의 4.3배 · 콜라보와 솔로 차이 없음 | ✅ | 멤버별 순위는 표본 1~2곡 |
| 대규모 합방 | 조회수(분량으로) | 1.5~2.7배 · 동시시청자 0.9~2.4배 | ✅ | 연속 2일 이상만 이벤트로 인정 |
| 키리누키 | 공식 채널 밖 도달 | 클립당 본인 영상의 15% | ❌ 순간이 만든다 | 검색 표본, 비율은 상한 |
...
| 경쟁사 비교 | 같은 기간 성장 | 스텔라이브 +23,000 vs 홀로 +30,000 (11분의 1 규모) | — | 21일 · 1,000 반올림 |
| 호요버스 | 공식 푸시 → 언급 | 상관 -0.01 (없음) | — | 언급은 인기가 아니라 화제성 |
| 채널 성과 | 유튜브 조회수·성장 | 업로드 빈도 → 조회수 +0.68 · 규모 → 성장 -0.66 | ✅ | n=10 상관 |
| 방송 패턴 | 치지직 VOD·성장 | 시간·심야 → VOD +0.7, 성장은 규모에 딸림 | ✅ | n=10 상관 |
| 시장 | 배경 속도 | 시장 연 10%~16% vs 스텔라이브 36일 +2.7% | — | 한 달 연환산은 거칠다 |
...
| 날짜 | 이벤트 | 참여자 평균 배수 |
|---|---|---|
| 2026-08-31 | 스텔 여름 휴가 신의상 릴레이 공개 (9명) | 6.90배 |
| 2025-09-27 | 세번째 신의상 릴레이 공개 (4명) | 4.08배 |
| 2025-07-05 | 신의상 릴레이 공개 (3명) | 3.85배 |
| 2026-06-21 | 아라하시 타비 신의상 공개 | 3.63배 |
| 2026-06-23 | 마인크래프트 · 봉켓몬 | 2.65배 |
| 2025-12-22 | 마인크래프트 · 멋사 | 2.00배 |
| 2026-08-29 | 마인크래프트 | 1.98배 |
| 2026-05-23 | 마인크래프트 · 모라하지마 | 1.95배 |
| 2025-10-07 | 마인크래프트 | 1.88배 |
...
| 지표 | 신의상 공개 | 대규모 합방 |
|---|---|---|
| VOD 조회수 배수 | **3.6~6.9배** | 1.5~2.7배 |
| 동시시청자 피크 배수 | **0.8~17.6배** | 0.9~2.4배 |

| 멤버 | 공개일 피크 | 평소 피크 | 배수 |
|---|---|---|---|
| 사키하네 후야 | 38,402 | 2,186 | **17.57배** |
| 네네코 마시로 | 28,071 | 3,097 | **9.06배** |
| 아라하시 타비 | 38,237 | 4,356 | **8.78배** |
| 하나코 나나 | 24,385 | 3,187 | **7.65배** |
| 시라유키 히나 | 4,448 | 3,710 | **1.20배** |
| 유즈하 리코 | 3,503 | 3,056 | **1.15배** |
...
|---|---|---|---|---|---|---|
| Maid My Way | 아오쿠모 린 | 2026-07-27 | 1,826,757 | 89,147 | **20.5배** | 2.2배 |
| 악당주의보 | 유즈하 리코 | 2026-07-24 | 1,419,074 | 133,025 | **10.7배** | 9.7배 |
| Hush Trap | 하나코 나나 | 2026-07-26 | 981,230 | 117,383 | **8.4배** | 2.4배 |
| Berry Verry Strawberry | 텐코 시부키 | 2026-07-25 | 1,060,321 | 142,697 | **7.4배** | — |

오리지널곡 MV 는 그 멤버의 일반 영상보다 **7.4~20.5배** 본다. 같은 멤버의
커버곡과 비교해도 **2.2~9.7배**다. 지금까지 잰 이벤트 중 단일 콘텐츠로는
천장이 가장 높다.
...
읽어야 한다. 유즈하 리코의 커버 대비 배수(9.7배)가 유독 큰 것도 곡이 세서가
...
|---|---|---|---|---|
| 아오쿠모 린 | 2곡 | 821,040 | 104,753 | **7.84배** |
| 시라유키 히나 | 1곡 | 507,951 | 98,998 | **5.13배** |
| 아카네 리제 | 2곡 | 683,396 | 141,850 | **4.82배** |
| 아라하시 타비 | 1곡 | 457,662 | 102,991 | **4.44배** |
| 아야츠노 유니 | 1곡 | 373,760 | 87,423 | **4.28배** |
| 네네코 마시로 | 2곡 | 231,348 | 59,228 | **3.91배** |
| 하나코 나나 | 2곡 | 411,881 | 106,096 | **3.88배** |
| 사키하네 후야 | 1곡 | 277,179 | 82,161 | **3.37배** |
| 유즈하 리코 | 8곡 | 145,718 | 171,524 | **0.85배** |

커버곡은 그 멤버의 일반 영상보다 **중앙값 4.3배** 본다. 10명 중 9명이 2.8~7.4배에
들어간다.

**콜라보 커버가 더 잘 되지는 않는다.** 2026년 커버만 놓고 보면 솔로 379,607회 ·
콜라보 367,321회로 차이가 없다. 전체 기간으로는 콜라보가 높아 보이는데, 콜라보 커버가
**2024년부터만 존재해서** 생기는 착시다(그 이전 카탈로그는 전부 솔로).

### 읽을 때 주의

유즈하 리코만 0.85배로 유일하게 1배 미만이고, 동시에 커버를 가장 자주 올린다
...
|---|---|---|---|---|---|
| 2026-07-11 아카네 리제 첫 단독 콘서트 | 아카네 리제 | 4건 | 13,610 | 2,301 | **5.91배** |
| 2025-12-20 2025 THE 1ST STELLIVE  | 시라유키 히나 | 2건 | 11,446 | 4,271 | **2.68배** |
| 2025-12-20 2025 THE 1ST STELLIVE  | 사키하네 후야 | 1건 | 3,549 | 2,726 | **1.30배** |
| 2025-12-20 2025 THE 1ST STELLIVE  | 아카네 리제 | 7건 | 3,933 | 3,268 | **1.20배** |
| 2025-12-20 2025 THE 1ST STELLIVE  | 유즈하 리코 | 1건 | 5,042 | 4,186 | **1.20배** |
| 2025-12-20 2025 THE 1ST STELLIVE  | 하나코 나나 | 1건 | 3,968 | 3,791 | **1.05배** |

**본인 단독 콘서트가 그룹 합동보다 훨씬 크게 남는다.** 아카네 리제의 첫 단독 콘서트
후기 방송은 평소의 5.9배였고, 콘서트 안내 쇼츠는 **1,733,786회**로 그 채널
...
|---|---|---|---|---|---|---|
| 사키하네 후야 | 134,000 | 113,106 | 3.6 | 26% | 4.1% | **+3.08%** |
| 유즈하 리코 | 220,000 | 289,581 | 5.7 | 40% | 3.6% | **+2.80%** |
| 텐코 시부키 | 229,000 | 191,690 | 6.5 | 48% | 4.2% | **+2.23%** |
| 아오쿠모 린 | 282,000 | 189,815 | 4.3 | 24% | 3.7% | **+2.17%** |
| 아카네 리제 | 354,000 | 304,622 | 5.4 | 38% | 3.4% | **+2.02%** |
| 하나코 나나 | 205,000 | 185,284 | 5.8 | 52% | 4.4% | **+1.99%** |
| 아라하시 타비 | 260,000 | 189,331 | 4.2 | 22% | 3.8% | **+1.96%** |
| 네네코 마시로 | 183,000 | 106,730 | 2.0 | 8% | 4.6% | **+1.67%** |
| 아야츠노 유니 | 361,000 | 131,576 | 2.8 | 20% | 3.6% | **+0.84%** |
| 시라유키 히나 | 320,000 | 192,382 | 3.4 | 34% | 3.5% | **+0.31%** |

| 요인 | → 평균 조회수 | → 26일 구독자 성장 |
|---|---|---|
| 주당 업로드 | +0.68 | +0.46 |
| 쇼츠 비중 | +0.57 | +0.20 |
| 참여율 | -0.59 | +0.25 |
...
-0.66** — 이미 큰 채널일수록 느리게 큰다. 참여율은 조회수와 음(−), 성장과 양(+)이라
...
|---|---|---|---|---|---|---|---|
| 사키하네 후야 | 163,601 | 26h | 5.1h | 38% | 30% | 3,589 | **+4.37%** |
| 하나코 나나 | 213,425 | 22h | 5.2h | 51% | 73% | 3,922 | **+2.89%** |
| 아오쿠모 린 | 225,422 | 21h | 4.6h | 65% | 88% | 3,896 | **+2.88%** |
| 유즈하 리코 | 215,218 | 33h | 6.8h | 65% | 36% | 4,495 | **+2.81%** |
| 네네코 마시로 | 215,252 | 25h | 4.8h | 23% | 42% | 3,312 | **+2.59%** |
| 아카네 리제 | 258,903 | 23h | 5.0h | 65% | 52% | 3,700 | **+2.37%** |
| 아라하시 타비 | 261,279 | 38h | 7.3h | 66% | 49% | 5,473 | **+2.33%** |
| 텐코 시부키 | 245,857 | 35h | 7.0h | 80% | 69% | 6,751 | **+1.97%** |
| 아야츠노 유니 | 306,269 | 35h | 6.3h | 46% | 24% | 3,920 | **+1.44%** |
| 시라유키 히나 | 239,692 | 34h | 5.9h | 70% | 36% | 5,829 | **+1.20%** |

| 요인 | → 평균 VOD 조회수 | → 26일 팔로워 성장 |
|---|---|---|
| 주당 방송 시간 | +0.72 | -0.53 |
| 평균 방송 길이 | +0.74 | -0.42 |
| 심야 비중 | +0.76 | -0.39 |
...
스텔라이브 탤런트 10명의 유튜브 구독자 합계는 2026-08-03 2,480,000 → 2026-09-08 2,548,000
(**+2.74%**, 36일)이다. 단순 연환산하면 +32%로 시장 성장률의 몇 배지만,
...
매칭 가능한 캐릭터 203명 중 60%만 리뷰에 한 번이라도 언급된다.
...
| 붕괴:스타레일 | 키레네 | 2025-11-05 | **18** | 22위 | -1.22 |
...
### ② 스텔라이브 접점 — 방송 57건 / 2960건 (1.9%)

| 멤버 | 게임 | 방송 | 호요 방송 중앙 | 평소 중앙 | 배수 | [광고] | 광고 배수 | 비광고 배수 |
|---|---|---|---|---|---|---|---|---|
| 아카네 리제 | 붕괴: 스타레일 | 21회 | 6,630 | 2,926 | **2.27배** | 3회 | 1.12배 | 2.30배 |
| 하나코 나나 | 붕괴: 스타레일 | 17회 | 4,206 | 3,121 | **1.35배** | 5회 | 1.11배 | 1.41배 |
| 유즈하 리코 | 젠레스 존 제로 | 8회 | 4,377 | 3,949 | **1.11배** | 3회 | 0.91배 | 1.15배 |
| 사키하네 후야 | 젠레스 존 제로 | 7회 | 1,930 | 2,253 | **0.86배** | 1회 | 1.42배 | 0.77배 |

방송 3회 이상인 멤버 4명 중 **아카네 리제만 평소보다 확실히 더 본다**(2.27배, 붕괴: 스타레일 21회). 나머지는 하나코 나나 1.35배·유즈하 리코 1.11배·사키하네 후야 0.86배로 평소와 같거나 낮다. 게임 자체가 시청자를 끌지는 않고, 그 멤버의 주력 콘텐츠일 때만 세다. 또 하나 — **[광고] 방송은 같은 게임의 비광고 방송보다 덜 본다.** 광고 2회 이상인 3명 중 3명이 그렇고(아카네 리제 1.12배 vs 2.30배·하나코 나나 1.11배 vs 1.41배·유즈하 리코 0.91배 vs 1.15배), 광고 방송은 게임을 '하는' 게 아니라 '보여주는' 방송이라 시청자가 덜 붙는 것으로 읽힌다.
...
### 같은 기간 성장 (2026-08-12 → 2026-09-07, 26일)

| 그룹 | 구독자 합계 | 증감 | 성장률 | 멤버 중앙값 | 오른 멤버 | 내린 멤버 |
|---|---|---|---|---|---|---|
| StelLive | 1,612,000 | **+23,000** | **+1.45%** | +1.81% | 6/6 | 0/6 |
| 홀로라이브 | 18,060,000 | **+30,000** | **+0.17%** | +0.00% | 2/6 | 1/6 |
| 이세계아이돌 | 2,475,000 | **-7,000** | **-0.28%** | -0.26% | 0/6 | 6/6 |
...
|---|---|---|---|
| StelLive | 3.4편 | **4.4%** (8편) | 2.38배 |
| 홀로라이브 | 4.9편 | **0.6%** (1편) | 5.43배 |
| 이세계아이돌 | 4.0편 | **1.7%** (3편) | 2.06배 |

스텔라이브는 세 그룹 중 **업로드는 가장 적게 하면서 커버 비중은 가장 높다.** 그리고
커버가 일반 영상 대비 내는 배수는 StelLive 2.38배 · 홀로라이브 5.43배 · 이세계아이돌 2.06배로 거의 같다 — **커버라는 레버 자체는 그룹을 가리지
...
|---|---|---|---|
| StelLive | 290,000 | **0.69** | 3.5% |
| 홀로라이브 | 2,715,000 | **0.13** | 6.6% |
| 이세계아이돌 | 415,000 | **0.23** | 5.5% |
...
⚠ **26일·그룹당 6명·1,000 단위 반올림**이다. 홀로라이브 270만 채널은 +999명이
늘어도 0으로 보이므로 상대 성장률 비교는 스텔라이브에 유리하다. 절대 증가로는
스텔라이브 +23,000명 · 홀로라이브 +30,000명으로 **11분의 1 규모에서 같은
수를 더했다**가 정확한 진술이다.
...
멤버별 감성 점수(0.33~0.93)와 최근 21일 치지직 팔로워 성장률의 상관은 **+0.23**(n=10)다. 방향이 있다고 말할 수준이 아니다. 점수 자체도 멤버 간 차이가 거의 없다 — 최저인 멤버도 표본이 야구 영상에 쏠린 탓이지 여론이 나빠서가 아니다.
...
|---|---|---|---|---|---|---|
| 텐코 시부키 | 23편 | 4,998,760 | 95,003 | 143,825 | 0.66배 | 15개 |
| 아야츠노 유니 | 37편 | 3,273,517 | 18,130 | 95,839 | 0.19배 | 18개 |
| 아카네 리제 | 24편 | 2,909,957 | 23,773 | 195,149 | 0.12배 | 9개 |
| 네네코 마시로 | 42편 | 2,807,933 | 4,937 | 64,443 | 0.08배 | 14개 |
| 아라하시 타비 | 51편 | 2,269,143 | 15,224 | 109,186 | 0.14배 | 14개 |
| 하나코 나나 | 29편 | 1,780,471 | 19,666 | 120,586 | 0.16배 | 18개 |
| 시라유키 히나 | 31편 | 1,586,719 | 10,808 | 99,312 | 0.11배 | 14개 |
| 유즈하 리코 | 27편 | 1,275,642 | 26,038 | 173,133 | 0.15배 | 13개 |
| 아오쿠모 린 | 8편 | 897,140 | 41,385 | 108,293 | 0.38배 | 5개 |
| 사키하네 후야 | 27편 | 84,447 | 1,992 | 85,131 | 0.02배 | 4개 |

**클립 하나는 작지만 수가 많고, 공식 채널 밖에 있다.** 클립 조회수 중앙값은 그 멤버
영상의 **15%** 수준이다(멤버별로 2%~67%로 편차가 크다 — 사키하네 후야가
0.02배로 최저인 건 2025-09 데뷔라 클립 생태계가 아직 얇기 때문이고, 텐코 시부키가
0.67배로 최고인 건 역대 1위 클립을 포함한 소수의 큰 클립이 끌어올린 결과다). 대신 멤버당 8~51편이 76개 채널에서
...
| 주제 | 클립 수 | 비중 | 조회수 중앙값 |
|---|---|---|---|
| 커버·노래 | 64편 | 21.4% | 38,472 |
| 합방·서버 | 7편 | 2.3% | 42,920 |
| 신의상 | 4편 | 1.3% | 39,280 |
| 게임 | 3편 | 1.0% | 40,918 |
| **어느 것도 아님** | — | **75.3%** | — |

여기가 다른 이벤트와 갈리는 지점이다. 표본 299건 중 **75%가 어떤
이벤트 키워드에도 걸리지 않는다.** 상위 클립 제목이 「말 실수한 유니」·「하이요 얼굴
공개 ㄷㄷ」·「힘드신군뇨」처럼 **방송 중 우연한 순간**이다. 커버·노래만 예외적으로
21%를 차지하고, 실제로 역대 1위 클립도 커버 라이브다.
...
클립 299건이 76개 채널에서 나오는데, **상위 3개 채널이 조회수의
29%, 상위 10개가 61%**를 가져간다. 2차창작이 넓게 퍼져 있다기보다
...
관측된 방송 세션 855건의 피크 분포는 심하게 치우쳐 있다 — 중앙값 **3,520명**, 상위 5% 7,254명, 상위 1% 9,912명, 최대 **38,402명**. 평균 근처에 몰려 있는 게 아니라 꼬리가 길다.
...
| 시작 시간대 | 3,253 ~ 3,849명 | 1.2배 |
| 요일 | 2,887 ~ 3,969명 | 1.4배 |
...
|---|---|---|---|---|---|
| 2026-08-31 | 스텔 여름 휴가 신의상 릴레이 공개 (9명) | 사키하네 후야 | 38,402 | 2,186 | 17.57배 |
| 2026-08-31 | 스텔 여름 휴가 신의상 릴레이 공개 (9명) | 네네코 마시로 | 28,071 | 3,097 | 9.06배 |
| 2026-08-31 | 스텔 여름 휴가 신의상 릴레이 공개 (9명) | 아라하시 타비 | 38,237 | 4,356 | 8.78배 |
| 2026-08-31 | 스텔 여름 휴가 신의상 릴레이 공개 (9명) | 하나코 나나 | 24,385 | 3,187 | 7.65배 |
| 2026-08-29 | 마인크래프트 | 사키하네 후야 | 4,734 | 1,991 | 2.38배 |
| 2026-08-29 | 마인크래프트 | 네네코 마시로 | 7,068 | 3,068 | 2.30배 |
| 2026-08-29 | 마인크래프트 | 아오쿠모 린 | 5,957 | 3,415 | 1.74배 |
| 2026-08-29 | 마인크래프트 | 텐코 시부키 | 7,381 | 4,653 | 1.59배 |
...
| 2026-09-01 | 아틀란티스 소녀 (Atlantis Princes | 시라유키 히나 | 치지직 팔로워 | +28 | +145 | +418.2% |
...
| 2026-08-31 | High Hopes - Panic! At The | 아라하시 타비 | 치지직 팔로워 | +165 | +266 | +61.2% |
| 2026-09-01 | 구르는 바위, 네게 아침이 내린다 [결속밴드 / | 네네코 마시로 | 치지직 팔로워 | +178 | +219 | +23.4% |
| 2026-09-02 | mosi mosi? (楽音 / 사사네)  / 텐 | 텐코 시부키 | 유튜브 구독자 | +167 | +200 | +20.0% |
| 2026-09-01 | 구르는 바위, 네게 아침이 내린다 [결속밴드 / | 네네코 마시로 | 유튜브 구독자 | +167 | +167 | +0.0% |
| 2026-08-31 | High Hopes - Panic! At The | 아라하시 타비 | 유튜브 구독자 | +167 | +143 | -14.3% |
