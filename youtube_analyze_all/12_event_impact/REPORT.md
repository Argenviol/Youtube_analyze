...
- **게임사의 공식 푸시는 유저 언급을 만들지 못한다**(상관 -0.05). 희귀도(5성)는
...
| 호요버스 | 공식 푸시 → 언급 | 상관 -0.05 (없음) | — | 언급은 인기가 아니라 화제성 |
...
|---|---|---|---|---|---|---|---|
| 사키하네 후야 | 165,799 | 26h | 5.0h | 38% | 31% | 3,597 | **+5.78%** |
| 유즈하 리코 | 218,127 | 34h | 7.0h | 67% | 38% | 4,542 | **+4.20%** |
| 하나코 나나 | 215,637 | 23h | 5.3h | 52% | 74% | 3,973 | **+3.96%** |
| 아오쿠모 린 | 227,325 | 21h | 4.7h | 65% | 87% | 3,987 | **+3.75%** |
| 아카네 리제 | 261,307 | 23h | 5.0h | 65% | 52% | 3,763 | **+3.32%** |
| 네네코 마시로 | 216,660 | 25h | 4.8h | 22% | 42% | 3,349 | **+3.26%** |
| 아라하시 타비 | 263,403 | 39h | 7.4h | 67% | 51% | 5,592 | **+3.16%** |
| 텐코 시부키 | 248,163 | 35h | 7.1h | 81% | 72% | 6,848 | **+2.92%** |
| 아야츠노 유니 | 307,844 | 36h | 6.3h | 46% | 27% | 3,848 | **+1.96%** |
| 시라유키 히나 | 241,140 | 36h | 6.2h | 71% | 39% | 5,856 | **+1.81%** |
...
공식 푸시 순위(5성·최신순)와 언급률의 상관은 게임별로 **붕괴3rd +0.18 · 붕괴:스타레일 -0.09 · 원신 -0.30 · 젠레스 존 제로 +0.01** (평균 -0.05) — 없다.
출시 최신순과의 상관도 평균 +0.14로 약하다. 순위는 게임 안에서만 매긴 값이라
...
| 젠레스 존 제로 | 엘렌 | 2024-07-04 | **10** | 45위 | +1.51 |
...
|---|---|---|---|---|---|---|
| 텐코 시부키 | 24편 | 5,335,692 | 114,910 | 161,402 | 0.71배 | 15개 |
| 시라유키 히나 | 32편 | 3,037,382 | 33,197 | 116,966 | 0.28배 | 20개 |
| 아야츠노 유니 | 29편 | 2,770,597 | 6,293 | 100,553 | 0.06배 | 14개 |
| 아카네 리제 | 34편 | 2,282,579 | 19,021 | 226,581 | 0.08배 | 19개 |
| 네네코 마시로 | 44편 | 2,273,603 | 5,189 | 74,675 | 0.07배 | 14개 |
| 하나코 나나 | 25편 | 1,777,713 | 26,200 | 129,406 | 0.20배 | 17개 |
| 아라하시 타비 | 45편 | 1,215,310 | 10,182 | 122,336 | 0.08배 | 14개 |
| 유즈하 리코 | 18편 | 909,439 | 14,993 | 178,779 | 0.08배 | 9개 |
| 아오쿠모 린 | 9편 | 132,389 | 9,983 | 110,690 | 0.09배 | 6개 |
...
0.67배로 최고인 건 역대 1위 클립을 포함한 소수의 큰 클립이 끌어올린 결과다). 대신 멤버당 9~45편이 85개 채널에서
...
| 주제 | 클립 수 | 비중 | 조회수 중앙값 |
|---|---|---|---|
| 커버·노래 | 60편 | 23.1% | 37,076 |
| 합방·서버 | 5편 | 1.9% | 10,553 |
| 게임 | 4편 | 1.5% | 43,888 |
| 신의상 | 1편 | 0.4% | 12,184 |
| **어느 것도 아님** | — | **73.8%** | — |

여기가 다른 이벤트와 갈리는 지점이다. 표본 260건 중 **74%가 어떤
...
클립 260건이 85개 채널에서 나오는데, **상위 3개 채널이 조회수의
30%, 상위 10개가 62%**를 가져간다. 2차창작이 넓게 퍼져 있다기보다
