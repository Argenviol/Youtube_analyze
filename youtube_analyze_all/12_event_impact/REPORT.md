...
|---|---|---|---|---|
| 오리지널곡 MV | 유튜브 조회수 | 일반 영상의 6~18배 | ✅ | 잴 수 있는 곡이 한 앨범 4곡 |
| 신의상 공개 | 치지직 동시시청자 | 평소 피크의 7~19배 (조회수 3.6~5.6배) | ✅ | 연 몇 회짜리 희소 이벤트 |
| 단독 콘서트 | 주변 방송 조회수 | 5.9배 (합동 페스티벌 1.1~2.7배) | ✅ | 구독자 전후 비교 불가(수집 이전) |
| 커버곡 | 유튜브 조회수 | 일반 영상의 4.0배 · 콜라보와 솔로 차이 없음 | ✅ | 멤버별 순위는 표본 1~2곡 |
| 대규모 합방 | 조회수(분량으로) | 1.4~2.7배 · 동시시청자 1.0~1.7배 | ✅ | 연속 2일 이상만 이벤트로 인정 |
| 키리누키 | 공식 채널 밖 도달 | 클립당 본인 영상의 12% | ❌ 순간이 만든다 | 검색 표본, 비율은 상한 |
| 동시시청자 | — | 평소 요인은 최대 2.1배, 이벤트는 7~19배 | — | 2026-08-12 이후만 |
...
| 채널 성과 | 유튜브 조회수·성장 | 업로드 빈도 → 조회수 +0.78 · 규모 → 성장 -0.70 | ✅ | n=10 상관 |
...
|---|---|---|---|---|---|---|
| 유즈하 리코 | 219,000 | 318,031 | 5.6 | 40% | 3.7% | **+2.34%** |
| 사키하네 후야 | 133,000 | 110,876 | 3.8 | 30% | 4.3% | **+2.31%** |
| 하나코 나나 | 205,000 | 193,092 | 5.4 | 52% | 4.4% | **+1.99%** |
| 아오쿠모 린 | 281,000 | 186,836 | 4.5 | 26% | 3.8% | **+1.81%** |
| 텐코 시부키 | 228,000 | 226,456 | 6.2 | 50% | 4.2% | **+1.79%** |
| 아카네 리제 | 353,000 | 306,273 | 5.5 | 40% | 3.5% | **+1.73%** |
| 네네코 마시로 | 183,000 | 99,887 | 2.0 | 8% | 4.8% | **+1.67%** |
| 아라하시 타비 | 259,000 | 189,299 | 4.2 | 20% | 3.8% | **+1.57%** |
| 아야츠노 유니 | 360,000 | 127,787 | 2.7 | 20% | 3.7% | **+0.56%** |
| 시라유키 히나 | 320,000 | 201,640 | 3.4 | 34% | 3.5% | **+0.31%** |
...
**업로드 빈도와 평균 조회수의 상관 +0.78** — 이 규모대에서는 물량이 조회수를
...
|---|---|---|---|---|---|---|---|
| 사키하네 후야 | 162,433 | 26h | 5.1h | 39% | 30% | 3,567 | **+3.63%** |
| 하나코 나나 | 212,558 | 22h | 5.2h | 51% | 73% | 3,898 | **+2.47%** |
| 유즈하 리코 | 214,234 | 33h | 6.8h | 65% | 36% | 4,437 | **+2.34%** |
| 아오쿠모 린 | 223,746 | 21h | 4.6h | 65% | 88% | 3,806 | **+2.12%** |
| 네네코 마시로 | 214,262 | 25h | 4.8h | 22% | 41% | 3,274 | **+2.12%** |
| 아라하시 타비 | 260,049 | 38h | 7.2h | 65% | 49% | 5,436 | **+1.85%** |
| 텐코 시부키 | 244,961 | 35h | 7.0h | 80% | 69% | 6,683 | **+1.59%** |
| 아카네 리제 | 256,701 | 24h | 5.0h | 65% | 53% | 3,621 | **+1.50%** |
| 아야츠노 유니 | 305,477 | 35h | 6.3h | 45% | 24% | 3,875 | **+1.18%** |
| 시라유키 히나 | 239,094 | 34h | 5.9h | 70% | 36% | 5,772 | **+0.95%** |
...
### ② 스텔라이브 접점 — 방송 59건 / 2956건 (2.0%)

| 멤버 | 게임 | 방송 | 호요 방송 중앙 | 평소 중앙 | 배수 | [광고] | 광고 배수 | 비광고 배수 |
|---|---|---|---|---|---|---|---|---|
| 아카네 리제 | 붕괴: 스타레일 | 21회 | 6,630 | 2,890 | **2.29배** | 3회 | 1.13배 | 2.33배 |
| 하나코 나나 | 붕괴: 스타레일 | 18회 | 4,235 | 3,119 | **1.36배** | 5회 | 1.11배 | 1.45배 |
| 유즈하 리코 | 젠레스 존 제로 | 9회 | 4,211 | 3,943 | **1.07배** | 3회 | 0.91배 | 1.11배 |
| 사키하네 후야 | 젠레스 존 제로 | 7회 | 1,930 | 2,248 | **0.86배** | 1회 | 1.43배 | 0.77배 |

방송 3회 이상인 멤버 4명 중 **아카네 리제만 평소보다 확실히 더 본다**(2.29배, 붕괴: 스타레일 21회). 나머지는 하나코 나나 1.36배·유즈하 리코 1.07배·사키하네 후야 0.86배로 평소와 같거나 낮다. 게임 자체가 시청자를 끌지는 않고, 그 멤버의 주력 콘텐츠일 때만 세다. 또 하나 — **[광고] 방송은 같은 게임의 비광고 방송보다 덜 본다.** 광고 2회 이상인 3명 중 3명이 그렇고(아카네 리제 1.13배 vs 2.33배·하나코 나나 1.11배 vs 1.45배·유즈하 리코 0.91배 vs 1.11배), 광고 방송은 게임을 '하는' 게 아니라 '보여주는' 방송이라 시청자가 덜 붙는 것으로 읽힌다.
...
관측된 방송 세션 356건의 피크 분포는 심하게 치우쳐 있다 — 중앙값 **3,568명**, 상위 5% 7,522명, 상위 1% 16,521명, 최대 **38,402명**. 평균 근처에 몰려 있는 게 아니라 꼬리가 길다.
...
| 2026-08-29 | 마인크래프트 | 네네코 마시로 | 5,765 | 3,425 | 1.68배 |
