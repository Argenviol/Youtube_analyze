...
- **가장 크게 터지는 이벤트는 합방이 아니라 신의상 공개다.** 조회수는 평소의
  **3.6~6.2배**(합방은 1.5~2.7배), 동시시청자 피크는
  **0.8~18.4배**(같은 기간 나란히 돌던 10인 마인크래프트 합방은
  0.9~2.4배)였다. 사키하네 후야의 첫 신의상은 38,402명 — 평소 피크의 19배다.
- **천장이 가장 높은 건 오리지널곡이다.** MV 가 일반 영상의 6.4~21.9배,
  같은 멤버의 커버곡과 비교해도 2.2~9.6배다. 다만 잴 수 있는 곡이
  한 앨범(4곡)뿐이라 **경향이 아니라 사례**로 읽어야 한다.
- **커버곡은 평소 영상의 4.1배 본다**(같은 기간·성숙 영상만 비교). 콜라보 커버가
  더 잘 되지는 않는다 — 2026년 기준 솔로와 콜라보의 조회수 중앙값이 같다.
- **콘서트는 단독이냐 합동이냐로 갈린다.** 본인 첫 단독 콘서트의 후기 방송은 평소의
  5.9배(안내 쇼츠 1,717,424회)였지만, 같은 멤버가 참여한 그룹 페스티벌은
  1.1~2.7배였다. 합동은 관심이 10명에게 나뉜다.
- **게임사의 공식 푸시는 유저 언급을 만들지 못한다**(상관 -0.01). 희귀도(5성)는
  효과가 있지만 푸시 순서는 없고, 인기는 구작 5성에 쌓여 있다. 스텔라이브 접점은 방송의
  2.0%뿐이며, 게임이 시청자를 끄는 게 아니라 그 멤버의 주력일 때만 평소를 넘는다.
...
|---|---|---|---|---|
| 오리지널곡 MV | 유튜브 조회수 | 일반 영상의 6~22배 | ✅ | 잴 수 있는 곡이 한 앨범 4곡 |
| 신의상 공개 | 치지직 동시시청자 | 평소 피크의 1~18배 (조회수 3.6~6.2배) | ✅ | 연 몇 회짜리 희소 이벤트 |
| 단독 콘서트 | 주변 방송 조회수 | 5.9배 (합동 페스티벌 1.1~2.7배) | ✅ | 구독자 전후 비교 불가(수집 이전) |
| 커버곡 | 유튜브 조회수 | 일반 영상의 4.1배 · 콜라보와 솔로 차이 없음 | ✅ | 멤버별 순위는 표본 1~2곡 |
| 대규모 합방 | 조회수(분량으로) | 1.5~2.7배 · 동시시청자 0.9~2.4배 | ✅ | 연속 2일 이상만 이벤트로 인정 |
| 키리누키 | 공식 채널 밖 도달 | 클립당 본인 영상의 12% | ❌ 순간이 만든다 | 검색 표본, 비율은 상한 |
...
| 경쟁사 비교 | 같은 기간 성장 | 스텔라이브 +19,000 vs 홀로 +20,000 (11분의 1 규모) | — | 21일 · 1,000 반올림 |
| 호요버스 | 공식 푸시 → 언급 | 상관 -0.01 (없음) | — | 언급은 인기가 아니라 화제성 |
| 채널 성과 | 유튜브 조회수·성장 | 업로드 빈도 → 조회수 +0.74 · 규모 → 성장 -0.70 | ✅ | n=10 상관 |
| 방송 패턴 | 치지직 VOD·성장 | 시간·심야 → VOD +0.7, 성장은 규모에 딸림 | ✅ | n=10 상관 |
| 시장 | 배경 속도 | 시장 연 10%~16% vs 스텔라이브 31일 +2.5% | — | 한 달 연환산은 거칠다 |
...
| 지표 | 신의상 공개 | 대규모 합방 |
|---|---|---|
| VOD 조회수 배수 | **3.6~6.2배** | 1.5~2.7배 |
| 동시시청자 피크 배수 | **0.8~18.4배** | 0.9~2.4배 |

| 멤버 | 공개일 피크 | 평소 피크 | 배수 |
|---|---|---|---|
| 사키하네 후야 | 38,402 | 2,092 | **18.36배** |
| 네네코 마시로 | 28,071 | 3,080 | **9.11배** |
| 아라하시 타비 | 38,237 | 4,287 | **8.92배** |
| 하나코 나나 | 24,385 | 3,172 | **7.69배** |
| 시라유키 히나 | 4,448 | 3,749 | **1.19배** |
| 유즈하 리코 | 3,503 | 3,044 | **1.15배** |
...
|---|---|---|---|---|---|---|
| Maid My Way | 아오쿠모 린 | 2026-07-27 | 1,751,117 | 79,804 | **21.9배** | 2.2배 |
| 악당주의보 | 유즈하 리코 | 2026-07-24 | 1,366,488 | 128,944 | **10.6배** | 9.6배 |
| Hush Trap | 하나코 나나 | 2026-07-26 | 964,857 | 117,236 | **8.2배** | 2.7배 |
| Berry Verry Strawberry | 텐코 시부키 | 2026-07-25 | 1,028,732 | 160,938 | **6.4배** | — |

오리지널곡 MV 는 그 멤버의 일반 영상보다 **6.4~21.9배** 본다. 같은 멤버의
커버곡과 비교해도 **2.2~9.6배**다. 지금까지 잰 이벤트 중 단일 콘텐츠로는
천장이 가장 높다.
...
|---|---|---|---|---|
| 아오쿠모 린 | 2곡 | 776,996 | 99,879 | **7.78배** |
| 시라유키 히나 | 2곡 | 472,093 | 98,706 | **4.78배** |
| 아카네 리제 | 2곡 | 640,538 | 135,312 | **4.73배** |
| 아라하시 타비 | 1곡 | 439,478 | 101,182 | **4.34배** |
| 아야츠노 유니 | 1곡 | 365,488 | 89,215 | **4.10배** |
| 네네코 마시로 | 2곡 | 227,063 | 58,662 | **3.87배** |
| 하나코 나나 | 2곡 | 362,216 | 99,967 | **3.62배** |
| 사키하네 후야 | 1곡 | 264,499 | 88,630 | **2.98배** |
| 유즈하 리코 | 7곡 | 143,148 | 164,094 | **0.87배** |

커버곡은 그 멤버의 일반 영상보다 **중앙값 4.1배** 본다. 10명 중 9명이 2.8~7.4배에
들어간다.

**콜라보 커버가 더 잘 되지는 않는다.** 2026년 커버만 놓고 보면 솔로 375,840회 ·
콜라보 359,130회로 차이가 없다. 전체 기간으로는 콜라보가 높아 보이는데, 콜라보 커버가
**2024년부터만 존재해서** 생기는 착시다(그 이전 카탈로그는 전부 솔로).

### 읽을 때 주의

유즈하 리코만 0.87배로 유일하게 1배 미만이고, 동시에 커버를 가장 자주 올린다
...
|---|---|---|---|---|---|
| 2026-07-11 아카네 리제 첫 단독 콘서트 | 아카네 리제 | 4건 | 13,541 | 2,291 | **5.91배** |
| 2025-12-20 2025 THE 1ST STELLIVE  | 시라유키 히나 | 2건 | 11,441 | 4,268 | **2.68배** |
...
| 2025-12-20 2025 THE 1ST STELLIVE  | 하나코 나나 | 1건 | 3,965 | 3,790 | **1.05배** |

**본인 단독 콘서트가 그룹 합동보다 훨씬 크게 남는다.** 아카네 리제의 첫 단독 콘서트
후기 방송은 평소의 5.9배였고, 콘서트 안내 쇼츠는 **1,717,424회**로 그 채널
...
|---|---|---|---|---|---|---|
| 유즈하 리코 | 219,000 | 322,304 | 5.7 | 40% | 3.7% | **+2.34%** |
| 사키하네 후야 | 133,000 | 112,320 | 3.8 | 30% | 4.2% | **+2.31%** |
| 하나코 나나 | 205,000 | 196,116 | 5.4 | 52% | 4.4% | **+1.99%** |
| 아오쿠모 린 | 281,000 | 181,081 | 4.4 | 24% | 3.8% | **+1.81%** |
| 텐코 시부키 | 228,000 | 203,310 | 6.3 | 50% | 4.3% | **+1.79%** |
| 아카네 리제 | 353,000 | 309,128 | 5.5 | 40% | 3.5% | **+1.73%** |
| 네네코 마시로 | 183,000 | 101,526 | 2.0 | 8% | 4.8% | **+1.67%** |
| 아라하시 타비 | 259,000 | 176,240 | 4.2 | 20% | 3.7% | **+1.57%** |
| 아야츠노 유니 | 360,000 | 127,795 | 2.7 | 20% | 3.7% | **+0.56%** |
| 시라유키 히나 | 320,000 | 200,216 | 3.4 | 34% | 3.5% | **+0.31%** |

| 요인 | → 평균 조회수 | → 21일 구독자 성장 |
|---|---|---|
| 주당 업로드 | +0.74 | +0.50 |
| 쇼츠 비중 | +0.60 | +0.28 |
| 참여율 | -0.57 | +0.40 |
...
**업로드 빈도와 평균 조회수의 상관 +0.74** — 이 규모대에서는 물량이 조회수를
견인한다(01의 결론 그대로). 쇼츠 비중도 같은 방향이다. 반면 **구독자 규모와 성장률은
-0.70** — 이미 큰 채널일수록 느리게 큰다. 참여율은 조회수와 음(−), 성장과 양(+)이라
...
|---|---|---|---|---|---|---|---|
| 사키하네 후야 | 162,803 | 26h | 5.1h | 39% | 30% | 3,571 | **+3.63%** |
| 하나코 나나 | 212,840 | 22h | 5.2h | 51% | 73% | 3,912 | **+2.47%** |
| 유즈하 리코 | 214,509 | 33h | 6.8h | 65% | 36% | 4,459 | **+2.34%** |
| 아오쿠모 린 | 224,691 | 21h | 4.6h | 65% | 88% | 3,862 | **+2.12%** |
| 네네코 마시로 | 214,631 | 25h | 4.8h | 22% | 42% | 3,288 | **+2.12%** |
| 아라하시 타비 | 260,225 | 38h | 7.2h | 65% | 49% | 5,448 | **+1.85%** |
| 텐코 시부키 | 245,202 | 35h | 7.0h | 80% | 69% | 6,723 | **+1.59%** |
| 아카네 리제 | 258,027 | 24h | 5.0h | 65% | 53% | 3,644 | **+1.50%** |
| 아야츠노 유니 | 305,801 | 35h | 6.3h | 45% | 24% | 3,895 | **+1.18%** |
| 시라유키 히나 | 239,368 | 34h | 5.9h | 70% | 37% | 5,784 | **+0.95%** |

| 요인 | → 평균 VOD 조회수 | → 21일 팔로워 성장 |
|---|---|---|
| 주당 방송 시간 | +0.72 | -0.43 |
| 평균 방송 길이 | +0.74 | -0.33 |
| 심야 비중 | +0.75 | -0.43 |
...
방송을 많이 해서 덜 크는 게 아니라, **팔로워 규모 → 성장 상관이 -0.85**로 압도적이라
...
스텔라이브 탤런트 10명의 유튜브 구독자 합계는 2026-08-03 2,480,000 → 2026-09-03 2,541,000
(**+2.46%**, 31일)이다. 단순 연환산하면 +33%로 시장 성장률의 몇 배지만,
...
매칭 가능한 캐릭터 203명 중 62%만 리뷰에 한 번이라도 언급된다.
...
|---|---|---|---|---|---|
| 붕괴:스타레일 | 반디 | 2024-06-19 | **71** | 62위 | +0.33 |
| 붕괴:스타레일 | 아케론 | 2024-03-27 | **25** | 68위 | +0.31 |
| 원신 | 푸리나 | 2023-11-06 | **20** | 78위 | +0.92 |
| 원신 | 마비카 | 2024-12-30 | **19** | 46위 | -0.63 |
| 붕괴:스타레일 | 은랑 | 2023-06-07 | **18** | 89위 | +0.66 |
| 붕괴:스타레일 | 키레네 | 2025-11-05 | **18** | 22위 | -1.23 |
| 붕괴:스타레일 | 파이논 | 2025-07-02 | **16** | 33위 | -0.42 |
| 원신 | 콜롬비나 | 2026-01-12 | **14** | 19위 | +0.66 |

언급 상위 8명의 푸시 순위 중앙값은 **54위**(낮을수록 강한 푸시)이고 출시는
...
### ② 스텔라이브 접점 — 방송 58건 / 2957건 (2.0%)

| 멤버 | 게임 | 방송 | 호요 방송 중앙 | 평소 중앙 | 배수 | [광고] | 광고 배수 | 비광고 배수 |
|---|---|---|---|---|---|---|---|---|
| 아카네 리제 | 붕괴: 스타레일 | 21회 | 6,630 | 2,894 | **2.29배** | 3회 | 1.13배 | 2.32배 |
| 하나코 나나 | 붕괴: 스타레일 | 18회 | 4,235 | 3,130 | **1.35배** | 5회 | 1.10배 | 1.44배 |
| 유즈하 리코 | 젠레스 존 제로 | 8회 | 4,367 | 3,944 | **1.11배** | 3회 | 0.91배 | 1.15배 |
| 사키하네 후야 | 젠레스 존 제로 | 7회 | 1,930 | 2,248 | **0.86배** | 1회 | 1.43배 | 0.77배 |

방송 3회 이상인 멤버 4명 중 **아카네 리제만 평소보다 확실히 더 본다**(2.29배, 붕괴: 스타레일 21회). 나머지는 하나코 나나 1.35배·유즈하 리코 1.11배·사키하네 후야 0.86배로 평소와 같거나 낮다. 게임 자체가 시청자를 끌지는 않고, 그 멤버의 주력 콘텐츠일 때만 세다. 또 하나 — **[광고] 방송은 같은 게임의 비광고 방송보다 덜 본다.** 광고 2회 이상인 3명 중 3명이 그렇고(아카네 리제 1.13배 vs 2.32배·하나코 나나 1.10배 vs 1.44배·유즈하 리코 0.91배 vs 1.15배), 광고 방송은 게임을 '하는' 게 아니라 '보여주는' 방송이라 시청자가 덜 붙는 것으로 읽힌다.
...
|---|---|---|---|
| StelLive | 3.4편 | **4.4%** (8편) | 2.33배 |
| 홀로라이브 | 4.6편 | **0.0%** (0편) | 커버 없음 |
| 이세계아이돌 | 4.2편 | **1.7%** (3편) | 2.13배 |

스텔라이브는 세 그룹 중 **업로드는 가장 적게 하면서 커버 비중은 가장 높다.** 그리고
커버가 일반 영상 대비 내는 배수는 StelLive 2.33배 · 이세계아이돌 2.13배로 거의 같다 — **커버라는 레버 자체는 그룹을 가리지
...
|---|---|---|---|
| StelLive | 289,500 | **0.67** | 3.5% |
| 홀로라이브 | 2,710,000 | **0.12** | 6.6% |
| 이세계아이돌 | 415,000 | **0.22** | 5.6% |
...
|---|---|---|---|---|---|---|
| 텐코 시부키 | 23편 | 4,918,990 | 94,996 | 142,482 | 0.67배 | 15개 |
| 네네코 마시로 | 48편 | 3,298,216 | 6,252 | 63,736 | 0.10배 | 17개 |
| 아카네 리제 | 28편 | 2,971,055 | 17,063 | 182,824 | 0.09배 | 12개 |
| 아야츠노 유니 | 36편 | 2,846,026 | 10,300 | 95,100 | 0.11배 | 18개 |
| 시라유키 히나 | 30편 | 1,647,723 | 10,149 | 104,059 | 0.10배 | 14개 |
| 하나코 나나 | 25편 | 1,411,497 | 19,549 | 116,697 | 0.17배 | 15개 |
| 아라하시 타비 | 43편 | 1,245,401 | 12,376 | 102,569 | 0.12배 | 9개 |
| 유즈하 리코 | 27편 | 1,218,657 | 26,019 | 167,946 | 0.15배 | 11개 |
| 아오쿠모 린 | 11편 | 1,084,850 | 45,155 | 107,552 | 0.42배 | 5개 |
| 사키하네 후야 | 26편 | 75,213 | 1,814 | 85,503 | 0.02배 | 4개 |
...
관측된 방송 세션 824건의 피크 분포는 심하게 치우쳐 있다 — 중앙값 **3,488명**, 상위 5% 7,062명, 상위 1% 9,482명, 최대 **38,402명**. 평균 근처에 몰려 있는 게 아니라 꼬리가 길다.
...
| 시작 시간대 | 3,222 ~ 3,909명 | 1.2배 |
| 요일 | 2,887 ~ 3,899명 | 1.4배 |
...
|---|---|---|---|---|---|
| 2026-08-31 | 스텔 여름 휴가 신의상 릴레이 공개 (9명) | 사키하네 후야 | 38,402 | 2,092 | 18.36배 |
| 2026-08-31 | 스텔 여름 휴가 신의상 릴레이 공개 (9명) | 네네코 마시로 | 28,071 | 3,080 | 9.11배 |
| 2026-08-31 | 스텔 여름 휴가 신의상 릴레이 공개 (9명) | 아라하시 타비 | 38,237 | 4,287 | 8.92배 |
| 2026-08-31 | 스텔 여름 휴가 신의상 릴레이 공개 (9명) | 하나코 나나 | 24,385 | 3,172 | 7.69배 |
| 2026-08-29 | 마인크래프트 | 사키하네 후야 | 4,734 | 1,991 | 2.38배 |
| 2026-08-29 | 마인크래프트 | 네네코 마시로 | 7,068 | 3,068 | 2.30배 |
| 2026-08-29 | 마인크래프트 | 아오쿠모 린 | 5,957 | 3,401 | 1.75배 |
