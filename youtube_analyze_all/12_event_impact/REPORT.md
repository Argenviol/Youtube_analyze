...
- **천장이 가장 높은 건 오리지널곡이다.** MV 가 일반 영상의 7.8~22.5배,
...
|---|---|---|---|---|
| 오리지널곡 MV | 유튜브 조회수 | 일반 영상의 8~23배 | ✅ | 잴 수 있는 곡이 한 앨범 4곡 |
...
|---|---|---|---|---|---|---|
| Maid My Way | 아오쿠모 린 | 2026-07-27 | 2,002,282 (음원 판 없음) | 88,868 | **22.5배** | 2.1배 |
...
오리지널곡 MV 는 그 멤버의 일반 영상보다 **7.8~22.5배** 본다. 같은 멤버의
...
| 유즈하 리코 | 217,759 | 34h | 7.0h | 67% | 38% | 4,537 | **+4.01%** |
...
| 텐코 시부키 | 247,933 | 36h | 7.1h | 81% | 71% | 6,862 | **+2.82%** |
...
멤버별 감성 점수(0.33~0.93)와 최근 21일 치지직 팔로워 성장률의 상관은 **+0.30**(n=10)다. 방향이 있다고 말할 수준이 아니다. 점수 자체도 멤버 간 차이가 거의 없다 — 최저인 멤버도 표본이 야구 영상에 쏠린 탓이지 여론이 나빠서가 아니다.
