...
- 데이터 소스: YouTube Data API v3 (채널 검색 + 영상 지표), 수집 2026-09-04
- 멤버 11명 · 커버곡 371개

## 핵심 요약
- **커버 총 조회수 1위**: 아카네 리제 — 107.5M (40곡)
- **최다 커버 업로드**: 유즈하 리코 — 60곡
- **곡당 평균 조회수 1위**: 아카네 리제 — 2.69M
- **역대 최고 조회 커버**: 아카네 리제 — 13.6M
