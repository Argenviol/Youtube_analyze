...
- 데이터 소스: YouTube Data API v3 (채널 검색 + 영상 지표), 수집 2026-09-25
- 멤버 11명 · 커버 영상 386개 = 곡 333곡
  (여러 판으로 올라온 곡 26곡)
...
## 핵심 요약
- **커버 총 조회수 1위**: 아카네 리제 — 112.2M (영상 41개 · 39곡
  · 음원 포함 112.2M)
- **최다 커버**: 유즈하 리코 — 56곡 (영상 61개)
- **영상당 평균 조회수 1위**: 아카네 리제 — 2.74M
- **역대 최고 조회 커버**: 아카네 리제 — 14.7M
